...
function createNewProject() {
  return postData(`https://jsconsole-api.herokuapp.com/api/v1/project/`, {
    ...
    window.location = `${currentLocation}editor/?id=${data._id}`;
...
function showPreview() {
  ...
  putData(`https://jsconsole-api.herokuapp.com/api/v1/project/${projectId}`, {
    name: generateName(),
    code: jsCode,
  }).then((data) => {
    console.log(data); // JSON data parsed by `data.json()` call
...
async function postData(url = "", data = {}) {
  ...
  const response = await fetch(url, {
    ...
    headers: {
      ...
      "Access-Control-Allow-Origin": "https://js-console.ml/",
    },
